                ...
                <div className="parent py-16 my-16 dark:bg-boxdark">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                        ...
                        >
                            <div className="flex items-center my-6">
                                <FaUserAlt className="text-2xl mr-8 text-primary duration-300"></FaUserAlt>
                                <h3 className="font-medium dark:text-white">Connect with us effortlessly and let your inquiries find swift resolutions. Our dedicated support team is here to listen, assist, and ensure your experience with our platform is seamless. Whether you have questions, feedback, or need technical assistance, we welcome your message. Reach out today, and let's build a better tomorrow together.</h3>
                            </div>
                            <div className="flex items-center my-6">
                                <FaPhoneAlt className="text-2xl mr-8 text-primary duration-300"></FaPhoneAlt>
                                <h3 className="font-medium dark:text-white">021-044</h3>
                            ...
                            <div className="flex items-center my-6">
                                <MdEmail className="text-3xl mr-8 text-primary duration-300"></MdEmail>
                                <h3 className="font-medium dark:text-white">your.email@example.com</h3>
                            </div>
                            <div className="flex items-center my-6">
                                <FaLocationArrow className="text-2xl mr-8 text-primary duration-300"></FaLocationArrow>
