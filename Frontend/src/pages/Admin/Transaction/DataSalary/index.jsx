...
const dataSalary = () => {
    ...
    const filtereddataSalary = dataSalary.filter((gajiDataPegawai) => {
        const isMatchBulan =
            filterBulan === "" ||
                ...
                <div className="flex justify-between items-center mt-4 flex-col md:flex-row md:justify-between">
                    <div className="flex items-center space-x-2">
                        <span className="text-gray-5 dark:text-gray-4 text-sm py-4">
                            Menampilkan {startIndex + 1}-{Math.min(endIndex, filtereddataSalary.length)} data {filtereddataSalary.length} Data Gaji Pegawai
                        </span>
                    </div>
