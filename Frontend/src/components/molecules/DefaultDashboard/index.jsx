...
const DefaultDashboard = () => {
    ...
    return (
        <Layout>
            ...
            {user && user.access_rights === "employee" && employeeData && (
                <>
                    <div className="mt-6">
                        <h2 className="px-4 py-2 text-meta-3 font-medium text-center md:text-left">
                            Welcome to EmployeeSmart. You are logged in as an Employee.
                        </h2>
                    </div>
                        ...
                        <div className="md:w-2/3 px-4 md:px-20 py-4 md:py-20">
                            <div className="w-full md:text-lg">
                                <h2 className="font-medium mb-4 block text-black dark:text-white">
                                    ...
                                    <span className="inline-block w-7">:</span>{employeeData.employee_id}
                                </h2>
                                <h2 className="font-medium mb-4 block text-black dark:text-white">
                                ...
                                <h2 className="font-medium mb-4 block text-black dark:text-white">
                                    <span className="inline-block w-32 md:w-40">Joining Date</span>
