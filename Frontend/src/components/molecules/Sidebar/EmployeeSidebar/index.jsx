...
import EmployeeSidebarLinkGroup from '../SidebarLinkGroup';
            ...
            <ul className='mb-6 flex flex-col gap-1.5'>
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('employeesalarydata') &&
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        Settings
                        <MdKeyboardArrowDown
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current text-2xl ${open && 'rotate-180'
                            }`}
                        />
                      </NavLink>
                      {/* <!-- Dropdown Menu Start --> */}
